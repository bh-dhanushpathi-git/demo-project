...
common_task = CommonTask(dag_id='schema1_399', dag_params={})
lineage_task = LineageTask(dag_id='schema1_399', dag_params={})
...
with DAG(
    ...
    start_flow_task = PythonOperator(
        ...
        params = {
            'flow_id': 513,
            'flow_name': 'schema1_399',
            'flow_key': 'schema1_399',
            'bh_project_id': 104,
    ...
    _submit_params = {
        ...
        "job_config": {
            ...
            "name": "{{ dag.dag_id }}_run_jobs_schema1_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/test/pipelines/bh_project_id=104/pipeline/pipeline_id=812/schema1.json",
                "databricks",
    ...
    run_jobs_schema1 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_jobs_schema1',
    ...
    create_compute >> run_jobs_schema1
    run_jobs_schema1 >> delete_compute
