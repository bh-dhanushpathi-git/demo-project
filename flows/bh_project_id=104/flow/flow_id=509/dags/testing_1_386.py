...
common_task = CommonTask(dag_id='testing_1_386', dag_params={})
lineage_task = LineageTask(dag_id='testing_1_386', dag_params={})
...
with DAG(
    ...
    start_flow_task = PythonOperator(
        ...
        params = {
            'flow_id': 509,
            'flow_name': 'testing_1_386',
            'flow_key': 'testing_1_386',
            'bh_project_id': 104,
    ...
    _validate_params = {
        ...
        "source_prefix": "bhargs/3-Claims/3-Claims/MSSP/small_data_day-2",
        "cloud_type": "databricks",
        "airflow_connection_id": "databricks_default",
        "secret_name": "bh-dev-westus3-kv-key-scope/bh-azureblob-blobstoragedbenv",
        "filename_regex": None,
        "min_bytes": 1,
        "max_bytes": None,
        "min_files": 1,
        ...
        "sources": [
            {
                "source_name": "eob",
                "prefix": "bhargs/3-Claims/3-Claims/MSSP/small_data_day-2",
                "min_bytes": 10,
                "min_files": 1
            },
            {
                "source_name": "safeharbor_coverage_mssp",
                "prefix": "bhargs/3-Claims/3-Claims/MSSP/small_data_day-2",
                "min_bytes": 10,
                "min_files": 1
            },
            {
                "source_name": "safeharbor_patient_mssp",
                "prefix": "bhargs/3-Claims/3-Claims/MSSP/small_data_day-2",
                "min_bytes": 10,
                "min_files": 1
            }
    ...
    _submit_params = {
        ...
        "job_config": {
            ...
            "name": "{{ dag.dag_id }}_run_pipelines_testing_1_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/test/pipelines/bh_project_id=104/pipeline/pipeline_id=790/testing_1.json",
                "databricks",
    ...
    run_pipelines_testing_1 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_testing_1',
    ...
    _submit_params = {
        ...
        "job_config": {
            "job_type": "spark_python",
            "name": "{{ dag.dag_id }}_run_pipelines_silver_raw_d0284_claims_to_target_load_260520_34d5_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/test/pipelines/bh_project_id=104/pipeline/pipeline_id=791/silver_raw_d0284_claims_to_target_load_260520_34d5.json",
                "databricks",
                "/Workspace/Shared/dev-utils/schemas"
            ]
        },
    ...
    run_pipelines_silver_raw_d0284_claims_to_target_load_260520_34d5 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_silver_raw_d0284_claims_to_target_load_260520_34d5',
        python_callable=submit_job_to_cluster,
        params=_submit_params,
        on_success_callback=common_task.success_callback,
        on_failure_callback=common_task.failure_callback,
    ...
    _archive_params = {
        "bucket_name": "my-test-bucket",
        "source_prefix": "",
        "archive_prefix": "Archive/bhargs/3-Claims/3-Claims/MSSP/small_data_day-2",
        "cloud_type": "databricks",
        "airflow_connection_id": "databricks_default",
        "secret_name": "bh-dev-westus3-kv-key-scope/bh-azureblob-blobstoragedbenv",
        "delete_source": True,
    ...
    create_compute >> run_pipelines_testing_1
    run_pipelines_testing_1 >> run_pipelines_silver_raw_d0284_claims_to_target_load_260520_34d5
    create_compute >> run_pipelines_silver_raw_d0284_claims_to_target_load_260520_34d5
    run_pipelines_silver_raw_d0284_claims_to_target_load_260520_34d5 >> archive_processed_files
